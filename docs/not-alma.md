...
<span style="display: inline-block; vertical-align: middle;">  [**Obsidian**](https://obsidian.md/) | <span style="color: red;">×</span> | Özel Lisans |  <i class="fa-brands fa-windows"></i> <i class="fa-brands fa-apple"></i> <i class="fa-brands fa-linux"></i> <i class="fa-brands fa-android"></i> <i class="fa-brands fa-app-store-ios"></i> | Lokal | 
...
### Obsidian
**Obsidian** not alma ve bilgi yönetimi için kullanılan, güçlü ve esnek bir uygulamadır. Uygulama, bağlantılı düşünme ve bilgi organizasyonu yöntemlerine odaklanır. Veriler tamamen cihazınızda saklanır, bu da gizlilik ve güvenlik açısından önemli bir avantajdır. Markdown formatını temel alır ve kullanıcıların birbirine bağlı bir not ağı (knowledge graph) oluşturmasını sağlar.
